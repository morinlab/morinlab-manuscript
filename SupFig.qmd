...
format:
    pdf:
        ...
        output-file: "Supplemental_Figures.pdf"
include-before-body:
    - text: |
        \captionsetup{justification=raggedright,singlelinecheck=false}
crossref:
    fig-title: "**Supplemental Figure**"
    fig-labels: "**arabic**"
    title-delim: "**.**"
...
```{r}
first_author <- sub("^([^\\^]+)\\^.*$", "\\1", parsed_authors$parsed_authors)
first_et_al <- paste0(
    "\\noindent\\hspace{4em}\\textbf{",
    first_author,
    " et al.}"
)
```
...
\noindent\hspace{4em}\textbf{Supplementary Information}
